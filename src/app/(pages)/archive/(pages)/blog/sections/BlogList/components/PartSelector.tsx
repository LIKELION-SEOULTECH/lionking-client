...
export default function PartSelector({ value, onChange }: PartSelectorProps) {
    return (
        <Select.Root value={value} onValueChange={(val) => onChange(val as PartFilters)}>
            <Select.Trigger className="flex items-center justify-between rounded-full px-5 py-2 body4_m text-gray-4 bg-gray-2 hover:bg-gray-3/70 cursor-pointer transition">
                <Select.Value />
